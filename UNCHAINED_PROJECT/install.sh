#!/bin/bash
# ============================================================
#  UNCHAINED PROJECT — Installer (macOS)
#
...
echo -e "${GREEN}${BOLD}  ║   UNCHAINED PROJECT — Installer              ║${NC}"
...
# UNCHAINED PROJECT — Configurazione
...
echo ""
echo "  🚴  UNCHAINED PROJECT — Avvio in corso..."
echo ""
