...
async def do_scan(config):
    ...
    from fuckzwift.ble.controllers import PLAY_SERVICE_UUID, CLICK_SERVICE_UUID
...
async def do_connect_trainer(address):
    ...
    from fuckzwift.ble.ftms import (
...
async def do_connect_controller(address, gear_system):
    from fuckzwift.ble.controllers import connect_click, connect_play
