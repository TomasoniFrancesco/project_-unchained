...
from fuckzwift.config import AppConfig
...
def create_app(config: AppConfig, gear_system, physics_engine, profile, strava_service) -> Flask:
    ...
    # Register blueprints
    from fuckzwift.web.routes_ui import ui_bp
    from fuckzwift.web.routes_api import api_bp
    from fuckzwift.web.sse import sse_bp
